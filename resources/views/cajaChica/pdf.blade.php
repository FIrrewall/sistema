        ...
        <thead>
            <tr>
                ...
                <td align="center"><strong>
                        <h2>DESCARGO DE <br> CAJA CHICA</h2>
                    </strong></td>
    ...
    <table border cellpadding=5 cellspacing=0 width="100%">
        <thead>
            <tr>
                ...
                <th align="center"><strong>Cliente del Proyecto</strong></th>
                <th align="center"><strong>Monto</strong></th>
            </tr>
        </thead>

        <tbody>
            @foreach($cajasChica as $cajaChica)
            @if($cajaChica->descargo_id == $resId)
            <tr>
                <td>{{$cajaChica->codigo}}</td>
                <td>{{$cajaChica->detalle}}</td>
                <td align=left>{{ \Carbon\Carbon::parse($cajaChica->fecha)->format('d-m-Y')}}</td>
                <td align=left>{{$cajaChica->proveedor}}</td>
                <td align=left>{{$cajaChica->clienteProyecto}}</td>
                <td align=right>{{$cajaChica->monto}}</td>
            </tr>
