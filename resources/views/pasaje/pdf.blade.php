...
<body>
    ...
    <table border cellpadding=5 cellspacing=0 width="100%">
        ...
        <tbody>
            ...
            @if($pasaje->descargo_id == $resId)
            <tr>
                <td>{{$pasaje->codigo}}</td>
                <td>{{$pasaje->detalle}}</td>
                <td align=left>{{ \Carbon\Carbon::parse($pasaje->fecha)->format('d-m-Y')}}</td>
                <td align=left>{{$pasaje->transporte}}</td>
                <td align=left>{{$pasaje->origen}}</td>
                <td align=left>{{$pasaje->destino}}</td>
                <td align=left>{{$pasaje->cliente}}</td>
                <td align=left>{{$pasaje->proyecto}}</td>
                <td align=right>{{$pasaje->monto}}</td>
            </tr>
