...
<div class="card card-dark">
    ...
    <div class="card-body">
        ...
        <form action="{{ url ('/productoventa')}}" method="post" entype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="col-md-5 mb-3">
                    <input type="hidden" class="form-control" name="venta_id" value="{{$idVen}}" id="venta_id" required>
                    <input type="hidden" class="form-control" name="reserva_id" value="{{$idRe}}" id="reserva_id" required>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right py-0 align-middle">
                            <form action="{{ url('/productoventa/'.$ven->id) }}" class="d-inline" method="post">
                                @csrf
                                {{method_field('DELETE')}}
        ...
        <div class="modal-footer justify-content-between">
            <a href="{{ url('/ventas/'.$idRe) }}" class="btn btn-primary"><i class="fas fa-undo-alt"></i> &nbsp;Atras</a>
        </div>
